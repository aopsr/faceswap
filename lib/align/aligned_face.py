...
def _transform_points(points, mat, invert=False):
    if invert:
...
def get_transform_mat (image_landmarks, output_size, whole_face=True, scale=1.0):
    ...
    mat = _umeyama(np.concatenate([image_landmarks[17:49], image_landmarks[54:55]]), landmarks_2D_new, True)[0:2]
    # get corner points in global space
    g_p = _transform_points(np.float32([(0,0),(1,0),(1,1),(0,1),(0.5,0.5)]) , mat, True)
    g_c = g_p[4]
